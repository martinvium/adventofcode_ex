defmodule Aoc.Year2021.Day07.TheTreacheryofWhales do
  ...
  `16,1,2,0,4,2,7,1,2,14`This means there's a crab with horizontal position `16`, a crab with horizontal
  ...
  def part_1(input) do
    ...
    |> Enum.reduce([], fn p1, acc ->
      fuel = Enum.reduce(positions, 0, fn p2, acc -> acc + abs(p1 - p2) end)
      [{p1, fuel} | acc]
    end)
